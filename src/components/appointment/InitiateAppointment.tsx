...
function InitiateAppointment() {
 ...
 <h1 > Initiate Appointment</h1>
  <Input controller='email' type='email' label="Patient" register={register} errors={errors} fields={{ required: true, maxLength: 10, minLength: 1 }}></Input>
  <Input controller='email' type='email' label="Subject" register={register} errors={errors} fields={{ required: true, maxLength: 10, minLength: 1 }}></Input>
